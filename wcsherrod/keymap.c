 ...
 */
    [_QWERTY] = LAYOUT(
      ...
      KC_LSPO, KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   KC_LGUI, KC_MS_BTN2, KC_CAPS, KC_LGUI, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSPC,
              KC_RCTL, KC_LGUI, LT(_NAV, KC_DEL), LT(_RAISE, KC_SPC), LT(_NUM, KC_ENT), L_BACKW, LT(_RAISE, KC_BSPC), LGUI_T(KC_DEL), KC_RGUI, TD(QUAD)
    ),
 ...
 */
    [_RAISE] = LAYOUT(
      _______, KC_1, 	  KC_2,    KC_3,    KC_MS_BTN3,    KC_5,                                        KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    _______,
      _______, KC_MS_BTN4, KC_MS_WH_DOWN, KC_MS_WH_UP, KC_MS_BTN1, KC_MS_BTN2,                                     KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, _______,
      KC_LSPO, KC_LCTL, _______, RCTL(KC_C), RCTL(KC_V), RCTL(KC_Z), RCS(KC_Z), _______, _______, _______, _______, KC_PGDOWN, KC_PGUP, KC_DOT, KC_SLSH, KC_RSPC,
