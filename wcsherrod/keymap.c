 ...
 */
    [_QWERTY] = LAYOUT(
      ...
      KC_LSPO, KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   LT(_NUM, KC_DEL), KC_MS_BTN2, KC_CAPS, KC_LGUI, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSPC,
              KC_RCTL, KC_LGUI, LT(_NAV, KC_ENT), LT(_RAISE, KC_SPC), KC_MS_BTN1, L_BACKW, LT(_RAISE, KC_BSPC), LGUI_T(KC_DEL), KC_RGUI, TD(QUAD)
    ),
 ...
 */
    [_RAISE] = LAYOUT(
      ...
      KC_LSPO, _______, _______, KC_MS_BTN2, RCTL(KC_C), RCTL(KC_V), RCTL(KC_Z), RCS(KC_Z), _______, _______, _______, KC_PGDOWN, KC_PGUP, KC_DOT, KC_SLSH, KC_RSPC,
